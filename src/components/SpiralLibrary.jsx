...
export default function SpiralLibrary() {
  return (
    <div className="flex flex-col items-center max-w-auto h-lvh align-top py-10 md:px-50 px-5 overflow-x-hidden">
      ...
      <p className="py-5">This library project in Seneca Falls, NY is based on the Musashino Art University Museum & Library by Sou Fujimoto Architects. In this integrative design studio, I have adapted the original’s spiral parti to this specific site. 

Offsets which follow the outline of a spiral were critical gestures to adhere to. Perforations within the walls are were made in such a way that the viewer sees, and is sometimes able to traverse, a spiral. In order to maximize the amount of space on the site, these offset walls were distorted in plan so that they took up the edges of the site.</p>
